...
export interface UseCompletionReturn {
  ...
  /** Persist toggling auto screen capture for each message */
  ...
  /** Whether a screenshot was automatically sent with the most recent message */
