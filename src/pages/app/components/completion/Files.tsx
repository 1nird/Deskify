...
export const Files = ({
  ...
  isChatPanelExpanded,
}: UseCompletionReturn & { isChatPanelExpanded: boolean }) => {
  ...
  return (
    <div className="relative">
      <Popover
        open={isFilesPopoverOpen && isChatPanelExpanded}
        onOpenChange={setIsFilesPopoverOpen}
      >
        <PopoverTrigger asChild>
          <Button
            ...
            className="cursor-pointer bg-black/40 hover:bg-black/60 border border-emerald-500/30 hover:border-emerald-400/60 text-emerald-400 hover:text-emerald-300 rounded-full h-[34px] w-[34px] transition-all duration-300 shadow-[inset_0_0_10px_rgba(16,185,129,0.05)] hover:shadow-[0_0_15px_rgba(16,185,129,0.2)] transform hover:scale-[1.05]"
            title={
              supportsImages
                ? "Attach images"
