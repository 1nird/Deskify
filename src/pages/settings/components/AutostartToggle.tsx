  ...
  return (
    <div id="autostart" className={`space-y-2 ${className}`}>
      <Header
        ...
        description="Automatically open Deskify when your system starts"
        isMainTitle
      />
        ...
        <div className="flex items-center space-x-3">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              {isEnabled
                ? "Deskify will launch automatically on system startup"
                : "Deskify will not launch automatically"}
            </p>
          </div>
        </div>
        <Switch
